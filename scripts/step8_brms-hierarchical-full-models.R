...
### exploratory figures ---
### exploring relationships described by Valencia et al. 2020
### https://www.pnas.org/doi/full/10.1073/pnas.1920405117#sec-1

### species level plots ---
# stabilty_synchrony <- dat_ready |>
#       ggplot(aes(x = synch, y = comm_n_stability, color = Program)) +
#       # geom_point() +
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) +
#       labs(x = "Scaled Population Synchrony",
...
#
# stabilty_turnover <- dat_ready |>
#       ggplot(aes(x = beta_time, y = comm_n_stability, color = Program)) +
#       # geom_point() +
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) +
#       labs(x = "Scaled Population Turnover",
#            y = "Scaled Aggregate Nitrogen Supply Stability") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
...
# ### trophic group plots ---
#
# stabilty_troph_synchrony <- dat_ready |>
#       ggplot(aes(x = troph_synch, y = comm_n_stability, color = Program)) +
#       # geom_point() +
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) +
#       labs(x = "Scaled Trophic Group Synchrony",
#            y = "Scaled Aggregate Nitrogen Supply Stability") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
...
#             legend.title = element_text(face = "bold", color = "black"))
#
# stabilty_trophic_turnover <- dat_ready |>
#       ggplot(aes(x = troph_beta_time, y = comm_n_stability, color = Program)) +
#       # geom_point() +
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) +
#       labs(x = "Scaled Trophic Group Turnover",
#            y = "Scaled Aggregate Nitrogen Supply Stability") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
...
#             legend.title = element_text(face = "bold", color = "black"))
#
# stability_trophic_richness <- dat_ready |>
#       ggplot(aes(x = mean_trophic_richness, y = comm_n_stability, color = Program)) +
#       geom_point() +
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) +
#       labs(x = "Scaled Trophic Group Richness",
#            y = "Scaled Aggregate Nitrogen Supply Stability") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
...
#             legend.title = element_text(face = "bold", color = "black"))
#
# trophic_synchrony_trophic_richness <- dat_ready |>
#       ggplot(aes(x = mean_trophic_richness, y = troph_synch, color = Program)) +
#       # geom_point() +
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) +
#       labs(x = "Scaled Trophic Group Richness",
#            y = "Scaled Trophic Group Synchrony") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
#             axis.text.y = element_text(face = "bold", color = "black"),
...
#             legend.title = element_text(face = "bold", color = "black"))
#
trophic_turnover_trophic_richness <- dat_ready |>
      ggplot(aes(x = mean_trophic_richness, y = troph_beta_time, color = Program)) +
      geom_point() +
      geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
      geom_smooth(method = "lm", se = FALSE) +
      labs(x = "Scaled Trophic Group Richness",
           y = "Scaled Trophic Group Turnover") +
      theme_classic() +
      scale_color_manual(values = program_palette) +
      theme(axis.text.x = element_text(face = "bold", color = "black"),
            axis.text.y = element_text(face = "bold", color = "black"),
...
ggsave("output/ms-second-round/plots/supplemental/raw-trophicrichness-trophicturnover.tiff", units = "in", width = 5,
       height = 5, dpi =  600, compression = "lzw")
ggsave("output/ms-second-round/plots/supplemental/raw-trophicrichness-trophicturnover.svg", units = "in", width = 5,
       height = 5, dpi =  600)

population_synchrony_trophic_richness <- dat_ready |>
      ggplot(aes(x = mean_trophic_richness, y = synch, color = Program)) +
      geom_point() +
      geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
      geom_smooth(method = "lm", se = FALSE) +
      labs(x = "Scaled Trophic Group Richness",
...
ggsave("output/ms-second-round/plots/supplemental/raw-trophicrichness-populationsynchrony.tiff", units = "in", width = 5,
       height = 5, dpi =  600, compression = "lzw")
ggsave("output/ms-second-round/plots/supplemental/raw-trophicrichness-populationsynchrony.svg", units = "in", width = 5,
       height = 5, dpi =  600)

population_synchrony_species_richness <- dat_ready |>
      ggplot(aes(x = mean_species_richness, y = synch, color = Program)) +
      geom_point() +
      geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
      geom_smooth(method = "lm", se = FALSE) +
...
ggsave("output/ms-second-round/plots/supplemental/raw-populationsynchrony-speciesrichness.tiff", units = "in", width = 5,
       height = 5, dpi =  600, compression = "lzw")
ggsave("output/ms-second-round/plots/supplemental/raw-populationsynchrony-speciesrichness.svg", units = "in", width = 5,
       height = 5, dpi =  600)
# 
dat |>
      ggplot(aes(x = comm_mean_n, y = comm_n_stability, color = Program)) +
      geom_point() +
      geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
      geom_smooth(method = "lm", se = FALSE) +
      labs(x = "Magnitude",
      ...
      theme(axis.text.x = element_text(face = "bold", color = "black"),
            ...
            legend.title = element_text(face = "bold", color = "black"))
# 
# trophic_synchrony_trophic_diversity <- dat_ready |> 
#       ggplot(aes(x = mean_trophic_diversity, y = troph_synch, color = Program)) +
#       # geom_point() +   
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) + 
#       labs(x = "Scaled Trophic Group Diversity",
#            y = "Scaled Trophic Group Synchrony") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
...
#             legend.title = element_text(face = "bold", color = "black"))
# 
# trophic_turnover_trophic_diversity <- dat_ready |> 
#       ggplot(aes(x = mean_trophic_diversity, y = troph_beta_time, color = Program)) +
#       # geom_point() +  
#       geom_smooth(aes(group = 1), method = "lm", size = 1, color = "black", linetype = "solid", se = FALSE) +
#       geom_smooth(method = "lm", se = FALSE) + 
#       labs(x = "Scaled Trophic Group Diversity",
#            y = "Scaled Group Turnover") +
#       theme_classic() +
#       scale_color_manual(values = program_palette) +
#       theme(axis.text.x = element_text(face = "bold", color = "black"),
#             axis.text.y = element_text(face = "bold", color = "black"),
...
rm(list = setdiff(ls(), c("dat_ready", "pr", "palette")))
